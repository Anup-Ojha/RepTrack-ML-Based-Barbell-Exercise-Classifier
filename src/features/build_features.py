...
# --------------------------------------------------------------
#Here we have added the missing values to our dataframe using 
#the interpolate function of the pandas in python 
...
ax[1].plot(subset["acc_y_lowpass"].reset_index(drop=True),label = " Butterworth lowpass filte")
...
subset [["acc_y" , "acc_y_temp_mean_ws_5", "acc_y_temp_mean_ws_5"]].plot()
subset [["gyr_y" , "gyr_y_temp_mean_ws_5", "gyr_y_temp_mean_ws_5"]].plot()    
